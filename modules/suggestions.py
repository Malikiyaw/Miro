...
class SuggestionModal(discord.ui.Modal, title="Create Suggestion"):
    suggestion_title = discord.ui.TextInput(label="Title", placeholder="Brief title for your suggestion")
    ...
    async def on_submit(self, interaction: discord.Interaction):
        if len(self.suggestion_title.value.strip()) < 5:
        ...
        await self.suggestion_system.submit_suggestion(interaction, self.suggestion_title.value.strip(), self.description.value.strip())
